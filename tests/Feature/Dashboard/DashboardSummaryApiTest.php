...
class DashboardSummaryApiTest extends TestCase
{
    ...
    public function test_dashboard_summary_returns_real_aggregates_for_current_company(): void
    {
        ...
        $this
            ...
            ->assertJsonPath('data.profit.gross_profit_base_amount', 270)
            ->assertJsonPath('data.profit.sales_cost_base_amount', 0)
            ->assertJsonPath('data.profit.profit_margin_percent', 100)
