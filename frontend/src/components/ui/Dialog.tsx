/**
 * Dialog (modal) basado en Radix UI.
 * Usar `<Dialog>` para confirmaciones de una sola accion o `<Dialog>` con
 * contenido mas complejo. Para paneles laterales usar Sheet (en lib/sheet).
 */
