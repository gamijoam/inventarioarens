...
export const ReceiveTransferItemSchema = z.object({
  // El backend (ReceiveInventoryTransferRequest y PrepareInventoryTransferRequest)
  // espera 'inventory_transfer_item_id' (el ID del item del transfer, NO del
  // transfer padre). Verificado en app/Modules/InventoryTransfers/Requests/.
  inventory_transfer_item_id: positiveNumber,
