...
export const SaleItemSchema = z.object({
  ...
  total_base_amount: moneyValue,
  base_unit_cost: moneyValue.nullable().optional(),
  base_total_cost: moneyValue.nullable().optional(),
  profit_base_amount: moneyValue.nullable().optional(),
  profit_margin_percent: moneyValue.nullable().optional(),
...
export const SaleSchema = z.object({
  ...
  total_base_amount: moneyValue,
  total_local_amount: moneyValue,
  cost_base_amount: moneyValue.nullable().optional(),
  profit_base_amount: moneyValue.nullable().optional(),
  profit_margin_percent: moneyValue.nullable().optional(),
