...
export const TransferRequestSchema = z.object({
  ...
  flow_type: z.enum(['stock_request', 'shipment_offer']).default('stock_request'),
  initiated_by_tenant_id: z.number().int().positive().optional(),
  sender_tenant_id: z.number().int().positive().optional(),
  receiver_tenant_id: z.number().int().positive().optional(),
  origin_tenant: TenantLiteSchema.nullable().optional(),
  destination_tenant: TenantLiteSchema.nullable().optional(),
  sender_tenant: TenantLiteSchema.nullable().optional(),
  receiver_tenant: TenantLiteSchema.nullable().optional(),
  from_warehouse_id: z.number().int().positive(),
  destination_warehouse_id: z.number().int().positive().nullable().optional(),
  sender_warehouse_id: z.number().int().positive().nullable().optional(),
  receiver_warehouse_id: z.number().int().positive().nullable().optional(),
  from_warehouse: WarehouseLiteSchema.nullable().optional(),
  destination_warehouse: WarehouseLiteSchema.nullable().optional(),
  sender_warehouse: WarehouseLiteSchema.nullable().optional(),
  receiver_warehouse: WarehouseLiteSchema.nullable().optional(),
