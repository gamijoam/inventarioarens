...
describe('inventoryColumnsConfig', () => {
  ...
  describe('Presets', () => {
    it('DEFAULT preset shows essential columns with SKU and hides Barcode', () => {
    ...
    it('SINGLE_PRICE_LIST_COLUMNS shows price_list and hides base_price', () => {
    ...
    it('ALL_INVENTORY_TABLE_COLUMNS enables all columns', () => {
    ...
    it('INVENTORY_COLUMN_DEFINITIONS marks name as required', () => {
