...
class UpdatePrintProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $profileId = $this->route('printProfile')?->id;

        return [
            'name' => ['sometimes', 'required', 'string', 'max:120', Rule::unique('print_profiles', 'name')->where('tenant_id', $tenantId)->ignore($profileId)],
