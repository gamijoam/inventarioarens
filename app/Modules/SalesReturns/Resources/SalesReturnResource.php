...
class SalesReturnResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'customer_credit_transaction_id' => $this->customer_credit_transaction_id,
            'exchange_sale_id' => $this->exchange_sale_id,
            'refund_financial_adjustment' => $this->whenLoaded('refundFinancialAdjustment'),
