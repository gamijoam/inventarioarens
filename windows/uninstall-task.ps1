...
#
# Uso: powershell -ExecutionPolicy Bypass -File windows/uninstall-task.ps1
...
& powershell.exe -ExecutionPolicy Bypass -File $legacyScript -Uninstall -TenantSlug "mi-empresa"
exit $LASTEXITCODE
